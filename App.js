      ...
      <View style={styles.buttons}>
        <View style={styles.numbers}>
          ...
          <View style={styles.row}>
            <TouchableOpacity
              ...
              style={styles.btn}
            >
              <Text style={[styles.number, {color:"green"}]}>.</Text>
            </TouchableOpacity>
            <TouchableOpacity
        ...
        <View style={styles.operations}>
          <TouchableOpacity
            ...
            style={styles.btn}
          >
            <Text style={[styles.operationButton, {color:'aqua'}]}>DEL</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => onOperationClick("AC")}
            style={styles.btn}
          >
            <Text style={[styles.operationButton, {color:'aqua'}]}>AC</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => onOperationClick("+")}
            style={styles.btn}
          >
            <Text style={[styles.operationButton, {color:'orange'}]}>+</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => onOperationClick("-")}
            style={styles.btn}
          ...
          <TouchableOpacity
            ...
            style={styles.btn}
          >
            <Text style={[styles.operationButton, {color:'orange'}]}>x</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
